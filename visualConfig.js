(function exposeSwordfightVisuals(root, factory) {
  ...
  const protocol = typeof module === "object" && module.exports
    ? require("./protocol")
    : root.SWORDFIGHT_PROTOCOL;
  const visuals = factory(protocol);
  if (typeof module === "object" && module.exports) module.exports = visuals;
  else root.SWORDFIGHT_VISUALS = visuals;
})(typeof globalThis !== "undefined" ? globalThis : this, (protocol) => {
  "use strict";

  const ITEM_ID = protocol.ITEM;
  ...
  return Object.freeze({
    ...
    INVENTORY: Object.freeze({
      ...
      slots: Object.freeze({
        [ITEM_ID.SWORD]: Object.freeze({
          name: "Katana",
          description: "Fight",
          art: Object.freeze({ type: "single", image: "sprites/tools/stone_sword.png", rotationDeg: 180, size: 72, top: 3 })
        }),
        [ITEM_ID.HAMMER]: Object.freeze({
          name: "Hammer",
          description: "Break",
          art: Object.freeze({ type: "single", image: "sprites/tools/stone_hammer.png", rotationDeg: 180, size: 61, top: 9 })
        }),
        [ITEM_ID.APPLE]: Object.freeze({
          name: "Apple",
          description: "Heal",
          art: Object.freeze({ type: "single", image: "sprites/food/apple.png", rotationDeg: 0, size: 59, top: 11 })
        }),
        [ITEM_ID.SPIKE]: Object.freeze({
          name: "Spike",
          description: "Damage",
          art: Object.freeze({ type: "single", image: "sprites/buildings/spike.png", rotationDeg: 0, size: 70, top: 5 })
        }),
        [ITEM_ID.TRAP]: Object.freeze({
          name: "Trap",
          description: "Freeze",
          art: Object.freeze({ type: "single", image: "sprites/buildings/trap.png", rotationDeg: 0, size: 63, top: 8 })
        }),
        [ITEM_ID.WALL]: Object.freeze({
          name: "Wall",
          description: "Block",
          art: Object.freeze({ type: "single", image: "sprites/buildings/wall.png", rotationDeg: 0, size: 70, top: 5 })
        }),
        [ITEM_ID.GATHERER]: Object.freeze({
          name: "Windmill",
